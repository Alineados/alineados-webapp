...
<button
	class={`group inline-flex items-center rounded-full border px-3 py-2 transition-transform duration-300 ease-in-out hover:border-alineados-green-900 hover:bg-alineados-green-900 hover:text-alineados-gray-50 ${
		selected
